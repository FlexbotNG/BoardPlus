...
$(function() {
  ...
  $('#thankyou-twitter-button').on('click', function(event) {
    var currentUrl = document.location.origin;
      var url = "https://twitter.com/share?text=I%20supported%20the%20Arduino%20Software%20with%20a%20donation!%20Check%20out&url="+currentUrl+"/en/Main/Donate";
  ...
  $('#thankyou-facebook-button').on('click', function(event) {
    ...
    FB.ui({
        ...
        name: 'Arduino - Donate',
        display: 'popup',
        description: 'I supported the Arduino Software with a donation!',
